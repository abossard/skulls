...
[ask-andre](https://github.com/abossard/skulls/blob/main/docs/engineering/ask-andre.md) routes across the whole set when you are unsure which skill the situation wants.
