...
- **[handoff](./handoff/SKILL.md)**: Compact a conversation into a portable handoff that separates verified observations, unverified claims, and evidence pointers.
...
- **[writing-for-agents](./writing-for-agents/SKILL.md)**: Write low-load, evidence-backed documents and context maps for agents.
